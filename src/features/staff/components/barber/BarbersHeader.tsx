...
export default function BarbersHeader() {
  const { search, setSearch, openCreate } = useBarberStore();
  ...
  return (
    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6">
      ...
      <div className="flex gap-4 w-full sm:w-auto">
        ...
        <button
          onClick={openCreate}
          className="bg-gradient-to-r from-orange-500 to-red-600 px-6 py-3 rounded-xl font-bold flex items-center gap-3 hover:scale-105 transition whitespace-nowrap"
        >
